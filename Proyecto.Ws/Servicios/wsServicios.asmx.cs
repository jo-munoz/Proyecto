...
namespace Proyecto.Ws.Servicios
{
    ...
    public class wsServicios : System.Web.Services.WebService
    {
        ...
        {
            Logica.BL.clsEventos obclsEvento = new Logica.BL.clsEventos();
            Logica.Models.clsEventos obclsEventos = JsonConvert.DeserializeObject<Logica.Models.clsEventos>(stclsEventos);

            obclsEvento.createEventos(obclsEventos);
        }
    }
}
